...
public class BlazeDsOpenApiComp
{
  protected static String nl;
  public static synchronized BlazeDsOpenApiComp create(String lineSeparator)
  {
    nl = lineSeparator;
    BlazeDsOpenApiComp result = new BlazeDsOpenApiComp();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(oatu.getTypeName(fw));
