...
public class BlazeDsMockDataJavaGrpc
{
  protected static String nl;
  public static synchronized BlazeDsMockDataJavaGrpc create(String lineSeparator)
  {
    nl = lineSeparator;
    BlazeDsMockDataJavaGrpc result = new BlazeDsMockDataJavaGrpc();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_12 = " build() {";
  protected final String TEXT_13 = NL + "\t\t";
  protected final String TEXT_14 = " r = new ";
  protected final String TEXT_15 = "();";
  protected final String TEXT_16 = NL + "\t\tr.";
  protected final String TEXT_17 = "(";
  protected final String TEXT_18 = "); ";
  protected final String TEXT_19 = NL + NL + "\t\treturn r;" + NL + "\t} " + NL + "}" + NL;
