...
public enum FwSelectType {
	...
	DISCRIMINATOR, // the disscriminator used for classes with @Inheritance (reactive cartridge)
	OFD,  // original fetch depth special field (reactive cartridge)
	;
}
